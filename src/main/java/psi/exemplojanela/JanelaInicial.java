...
public class JanelaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        campoUtilizador.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                campoUtilizadorCaretUpdate(evt);
            }
        });

        campoPassword.setText("...............");
        campoPassword.setActionCommand("<Not Set>");
    ...
    private void campoUtilizadorCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_campoUtilizadorCaretUpdate
        String aux = campoUtilizador.getText();
        botaoLogin.setEnabled(true);
        if(aux.length() == 0){
            botaoLogin.setEnabled(false);
        }
    }//GEN-LAST:event_campoUtilizadorCaretUpdate
    private void fazLogin(){
        if(botaoLogin.isEnabled()){
            String user = campoUtilizador.getText();
